...
private fun MovieDetailScreenPreview() {
    CineNowTheme {
        val movie = MovieDto(
            ...
            title = "Title",
            postPath = "ahsuahsu",
            overview = "Lore epsium lore epsium lore epsium lore epsium lore epsium lore epsium lore epsium lore epsium lore epsium lore epsium lore epsiumlore epsium"
        )
